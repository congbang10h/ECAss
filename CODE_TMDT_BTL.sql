...
--
-- Host: localhost
-- Generation Time: March 19, 2018 at 10:03 AM
...
(5, 'Overwatch', 4, 4, '{First-person shooter}', 1560, 5, 12, '24-May-2016', 'Hong Kong', 'Overwatch is a first-person shooter that features squad-based combat with two opposing teams of six players each.[1] Players choose one of several hero characters, each with their own unique abilities and role classes.'),
(6, 'Diablo 3', 4, 4, '{Action, RPG, hack and slash}', 1250, 4, 16, '15-May-2012', 'India', 'Diablo 3 is an action role-playing hack and slash video game. The player moves and interacts with the environment primarily by way of a mouse.[7] Other actions, such as casting a spell, are performed in response to keyboard inputs.[7] The player can acquire items, learn spells, defeat enemies, and interact with non-player characters (NPC)s throughout the game.'),
(7, 'Nier:Automata', 6, 5, '{Action, RPG, hack and slash}', 1990, 5, 16, '23-Feb-2017', 'U.K.', 'Nier: Automata is an open-world action role-playing game set on a post-apocalyptic Earth thousands of years after the events of the original Nier.[1] The player takes the role of combat androids from the YoRHa units across an open world environment.'),
...
(16, 'INSIDE', 9, 8, '{Atmospheric, Dark, Indie, Adventure, Puzzle}', 369, 5, 18, '7-Jul-2016', 'India', 'Hunted and alone, a boy finds himself drawn into the center of a dark project.'),
...
(19, 'Portal', 3, 3, '{Puzzle, First-Person, Singleplayer, Sci-fi, Action}', 219, 5, 0, '10-Oct-2007', 'Hong Kong', 'Portal™ is a new single player game from Valve. Set in the mysterious Aperture Science Laboratories, Portal has been called one of the most innovative new games on the horizon and will offer gamers hours of unique gameplay.'),
...
(1, 'Thanut', 'Saj', 'ots911', 123456, 'Male', 20, 'admin@ku.com', 'Thailand'),
...
--
ALTER TABLE `wishlists`
  MODIFY `wish_id` int(2) NOT NULL AUTO_INCREMENT;
--
